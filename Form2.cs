...
namespace FrmLab1
{
    public partial class Form2 : Form
    {
        ...
        {
            FrmRegistration fRegister = new FrmRegistration();
            fRegister.ShowDialog();
        }

        private void button2_Click(object sender, EventArgs e) // Find
        {
        ...
        {
            MessageBox.Show("Successfully Uploaded!" + lvShowText);
            lvShowText.Clear();
        }
    }
}
